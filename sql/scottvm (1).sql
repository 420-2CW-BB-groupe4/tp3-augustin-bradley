...
-- Table pour les produits
INSERT INTO tp3_produits (id_produit, nom_produit, description, prix, quantite_en_stock) VALUES (1,'Téléphone', 'Smartphone haut de gamme', 999.99, 100);
INSERT INTO tp3_produits (id_produit, nom_produit, description, prix, quantite_en_stock) VALUES (2,'Télévision', 'Téléviseur LCD HD', 1999.99, 50);
INSERT INTO tp3_produits (id_produit, nom_produit, description, prix, quantite_en_stock) VALUES (3,'Ordinateur portable', 'Ordinateur portable léger et portable', 2499.99, 80);
...
SELECT * FROM tp3_clients;

SELECT * FROM tp3_dates;